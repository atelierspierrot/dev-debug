...
// ----------------------------------
     ...
     * @return object The re-formated entered array
     */
     ...
     * @param string $class The class concerned (optional)
...
// ----------------------------------
     ...
     * @param array $value_cells
     * @param string $key_head
     * @param string $value_head
     ...
     * @param int $key The parameter index
     * @param string $format The format to send (HTML by default)
     * @return string The formated string to display
     */
...
*/
     ...
     *
     * @param array $infos An array of various information to write
...
// ----------------------------------
     ...
     * @param int $line The line number to see
     * @param string $fct A function name to see
     * @param int $surrounder Maximum number of lines to show before and after
